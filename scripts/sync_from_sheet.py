...
FIELD_MAPPING = {
    ...
    "title": ["Event Name", "event_name", "title", "event name"],
    "end_date": ["End Date", "end_date", "end date", "end date and time"],
    "category": [
    ...
    "acronym": ["Organization Acronym", "acronym", "organization acronym"],
    "organization_url": [
    ...
    "in_person": ["In-Person?", "in_person", "in person", "in-person"],
    "featured": ["Featured?", "featured"],
    "tags": ["Relevant Tags (Separated by commas)", "tags"],
...
def main() -> None:
                ...
                detected_changes.append(
                    {
                        ...
                        "event_data": mapped_event,
                        "similar_to": [
                            ev.get("title") for ev in similar_events
                        ]
                        if not s_id
                        else [],
                    }
    ...
    if not github_token:
        ...
        for change in detected_changes:
            ...
            if change_type == "add" and change.get("similar_to"):
                similar_str = ", ".join(
